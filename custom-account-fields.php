...
if ( !class_exists( 'CSCustomAccountFields' ) ) :

final class CSCustomAccountFields {
	/**
	 * @var string
	 */
    ...
    // add company identification number (ico)
		$fields['billing_company_placeholder'] = array(
        'type'          => 'checkbox',
		'label'     => __('Shop for business', 'custom-account-fields'),
		'placeholder'   => '',
		'required'  => false,
		'class'     => array('input-checkbox bill_placeholder'),
		'clear'     => false
		 );
...
CSCustomAccountFields::instance();
?>
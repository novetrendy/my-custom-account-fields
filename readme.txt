...
= EN =
1. Upload the plugin to your web presentation (eshop) or install via plugin management.
...
1. [Support Forum](http://wordpress.org/support/plugin/custom-account-fields)
1. [Support](mailto:custom-account-fields@monitom.cz)
